...
class DoublyLinkedList:
    ...
    def add_to_head(self, value):
        # changing length of list
        self.length += 1
        # setting a new ListNode to variable
        new_node = ListNode(value)
        # if there is no head or tail set the passed in value to the head and tail
